...
%   robot.
    ...
    lowerLim = [-3 -1.2 -1.8 -1.9 -2 -15]; % Lower joint limits in radians (grip in mm (negative closes more firmly))
    upperLim = [3 1.4 1.7 1.7 1.5 30]; % Upper joint limits in radians (grip in mm)
