...
S(1) = servoDirection(1) *qdot(1) * (180/pi/0.102);
S(2) = servoDirection(2) *qdot(2) * (180/pi/0.105);
S(3) = servoDirection(3) *qdot(3) * (180/pi/0.109);
S(4) = servoDirection(4) *qdot(4) * (180/pi/0.095);
S(5) = servoDirection(5) *qdot(5) * (180/pi/0.102);
S(6) = servoDirection(6) *qdot(6) / 0.028;
