...
if strcmpi(robotName, 'Legend') %DONE
    % Servo offsets
    servoOffsets = [1450, 1540, 1420, 1450, 1420, 2000];
    servoDirection = [-1,-1,1,-1,-1,1];
elseif  strcmpi(robotName, 'Loopy')
    % Servo offsets
    servoOffsets = [1450, 1250, 1470, 1560, 1600, 2000];
    servoDirection = [-1,-1,1,1,-1,1];
elseif  strcmpi(robotName, 'Lucky')
    % Servo offsets
    servoOffsets = [1500, 1660, 1520, 1500, 1460, 2000];
    servoDirection = [-1,-1,1,-1,-1,1];
elseif strcmpi(robotName, 'Lyric')  %DONE
    % Servo offsets
    servoOffsets = [1370, 1470, 1400, 1470, 1800, 2000];
    servoDirection = [-1,-1,1,-1,-1,1];
else
